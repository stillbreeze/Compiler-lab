...
int match(int init, int fin, int arr[4][2], int temp[50], int n_inputs, int expr_len, int out[4][2], int output[50])
{
    ...
    for(i=0;i<expr_len;i++)
    {
        ...
        {
            output[j]=out[current-1][temp[i]-1];
            j++;
...
int main()
{
    ...
    int arr[4][2]={{1,2},{2,3},{2,4},{3,0}}, out[4][2]={{1,2},{1,1},{1,2},{2,0}}, output[50], temp[50], expr_len;
    char expr[50];
